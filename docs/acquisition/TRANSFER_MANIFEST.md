# Transfer manifest â€” Add to your Cargo.toml

## Schedule A â€” Included (typical)

1. Git repository `theworker02/resonance` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Add to your Cargo.toml
